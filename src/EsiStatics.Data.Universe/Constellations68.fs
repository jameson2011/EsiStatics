...
module internal Constellations68=
    let getConstellation id = 
      ...
      | 20000207 -> { ConstellationData.id= 20000207; name= "Kainokai"; regionId= 10000016; solarSystemIds= [| 30001410; 30001411; 30001412; 30001413; 30001414; 30001415 |]; position= {x = -1.590764556e+17;  y = 7.565032608e+16;  z = 1.294249196e+17;} } |> Some
      ...
      | 20000401 -> { ConstellationData.id= 20000401; name= "Imurukka"; regionId= 10000033; solarSystemIds= [| 30002737; 30002738; 30002739; 30002740; 30002741; 30002742 |]; position= {x = -1.286970424e+17;  y = 9.81819818e+16;  z = 1.488765953e+17;} } |> Some
