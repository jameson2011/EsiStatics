...
module internal Constellations77=
    let getConstellation id = 
      match id with 
      | 20000022 -> { ConstellationData.id= 20000022; name= "Onirvura"; regionId= 10000002; solarSystemIds= [| 30000153; 30000154; 30000155; 30000156; 30000158 |]; position= {x = -9.050711587e+16;  y = 8.25506234e+16;  z = 9.746921388e+16;} } |> Some
      ...
      | 20000410 -> { ConstellationData.id= 20000410; name= "Otawasa"; regionId= 10000033; solarSystemIds= [| 30002794; 30002795; 30002796; 30002798; 30002799 |]; position= {x = -1.74377026e+17;  y = 7.255618733e+16;  z = 1.021927393e+17;} } |> Some
