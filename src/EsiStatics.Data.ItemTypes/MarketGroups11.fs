...
module internal MarketGroups11=
    let getMarketGroup id = 
      ...
      | 2145 -> { MarketGroupData.id= 2145; name= "Minmatar"; parentMarketGroupId= Some(2141); typeIds= [| 56900; 40517; 40326; 54919; 46890; 55693; 52862; 54910; 45951 |]; description= "" } |> Some
