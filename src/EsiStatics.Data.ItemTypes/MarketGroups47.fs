...
module internal MarketGroups47=
    let getMarketGroup id = 
      ...
      | 1696 -> { MarketGroupData.id= 1696; name= "Adaptive Shield Hardeners"; parentMarketGroupId= Some(553); typeIds= [| 9632; 578; 46010; 2281; 14764; 2050; 13998; 14765; 20637; 13969; 54291; 17498; 14766; 14767; 4345; 4346; 4347; 4348; 4349 |]; description= "Adaptive Shield Hardeners" } |> Some
      ...
      | 1987 -> { MarketGroupData.id= 1987; name= "Minmatar"; parentMarketGroupId= Some(1972); typeIds= [| 40514; 52900; 45989; 36444; 36843; 46926; 34671; 36796 |]; description= "" } |> Some
      | 2084 -> { MarketGroupData.id= 2084; name= "Minmatar"; parentMarketGroupId= Some(2068); typeIds= [| 52874; 36775; 36776; 52873; 45962; 45963; 40492; 40493; 36430; 36431; 46899; 46900; 36822; 36823; 48509; 48510 |]; description= "" } |> Some
      ...
      | 2278 -> { MarketGroupData.id= 2278; name= "Amarr"; parentMarketGroupId= Some(2277); typeIds= [| 49825; 46146; 54434; 47049; 52588; 49421; 41680; 53653; 47640; 48858; 42908; 42653 |]; description= "" } |> Some
