...
module internal MarketGroups86=
    let getMarketGroup id = 
      ...
      | 353651 -> { MarketGroupData.id= 353651; name= "Heavy Attack Vehicles"; parentMarketGroupId= Some(353566); typeIds= [|  |]; description= "" } |> Some
      | 354427 -> { MarketGroupData.id= 354427; name= "Speed Modifiers"; parentMarketGroupId= Some(353583); typeIds= [|  |]; description= "" } |> Some
      | 363448 -> { MarketGroupData.id= 363448; name= "Light"; parentMarketGroupId= Some(354471); typeIds= [|  |]; description= " " } |> Some
      | 366261 -> { MarketGroupData.id= 366261; name= "Standard"; parentMarketGroupId= Some(366260); typeIds= [|  |]; description= "" } |> Some
      | 377 -> { MarketGroupData.id= 377; name= "Spaceship Command"; parentMarketGroupId= Some(150); typeIds= [| 17940; 22551; 52997; 19719; 20524; 20525; 20526; 20527; 20528; 20530; 20531; 20532; 20533; 33856; 49742; 49743; 34390; 40535; 40536; 40537; 40538; 29029; 3184; 34327; 32918; 16591; 28374; 34533; 22761; 37615; 24311; 24312; 24313; 24314; 47867; 47868; 47869; 3327; 3328; 3329; 3330; 3331; 3332; 3333; 3334; 3335; 3336; 3337; 3338; 3339; 3340; 3341; 3342; 3343; 3344; 3345; 3346; 3347; 12092; 12093; 12095; 12096; 12098; 33091; 33092; 33093; 33094; 33095; 33096; 33097; 33098; 47445; 35680; 35685; 20342; 40328; 23950; 30650; 30651; 30652; 30653; 28609; 29637; 28615; 28656; 28667 |]; description= "Skills required for commanding all shapes and sizes of spaceships" } |> Some
