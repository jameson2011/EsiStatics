...
module internal MarketGroups37=
    let getMarketGroup id = 
      ...
      | 1977 -> { MarketGroupData.id= 1977; name= "Minmatar"; parentMarketGroupId= Some(2374); typeIds= [| 46726; 48524; 48525; 47508; 49430; 53018; 52892; 45981; 45982; 46919; 52893; 36788; 36789; 40506; 40507; 47292; 46014; 46015; 46918; 36449; 47177; 47179; 52434; 36835; 47321; 34657; 34658; 36451; 36836; 45555; 45556; 53435 |]; description= "" } |> Some
      | 2074 -> { MarketGroupData.id= 2074; name= "Caldari"; parentMarketGroupId= Some(2066); typeIds= [| 36655; 46843; 46116; 45839; 48182; 36727; 53176; 36345; 40603; 52635 |]; description= "" } |> Some
      ...
      | 619 -> { MarketGroupData.id= 619; name= "Implant Slot 02"; parentMarketGroupId= Some(532); typeIds= [| 53903; 28803; 33924; 54405; 28809; 33930; 28815; 33936; 53891; 20500; 20501; 33942; 33948; 33954; 33960; 52679; 33966; 52786; 33972; 52918; 53897; 20157; 33525; 31969; 53705; 42146; 19535; 31955; 9941; 53711; 14297; 31963; 22108; 42205; 53854; 19551; 10208; 10209; 22114; 42211; 13284; 32102; 31975; 22120; 32108; 22126; 32113; 33394; 22133; 32118; 28791; 54393; 54399; 28797; 33918; 33557 |]; description= "Implants intended for Subcervical Processing Slot 2." } |> Some
