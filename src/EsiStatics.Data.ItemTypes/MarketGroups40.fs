...
module internal MarketGroups40=
    let getMarketGroup id = 
      ...
      | 1980 -> { MarketGroupData.id= 1980; name= "Amarr"; parentMarketGroupId= Some(2377); typeIds= [| 43520; 34659; 34660; 42791; 45800; 46538; 47308; 48365; 37520; 36307; 46809; 49822; 42591 |]; description= "" } |> Some
      | 2077 -> { MarketGroupData.id= 2077; name= "Amarr"; parentMarketGroupId= Some(2067); typeIds= [| 46530; 37507; 46790; 36295; 48723; 42572; 48546; 48242; 43507; 45781; 42773 |]; description= "" } |> Some
      ...
      | 622 -> { MarketGroupData.id= 622; name= "Implant Slot 05"; parentMarketGroupId= Some(532); typeIds= [| 33920; 28805; 33926; 28811; 33932; 28817; 33938; 33561; 20504; 20505; 42201; 33950; 33956; 33962; 33968; 33974; 20160; 33527; 19538; 31971; 31957; 22116; 14299; 31965; 22110; 42208; 19555; 9956; 42214; 13286; 32104; 31977; 22122; 32110; 22128; 10225; 10226; 32115; 22135; 32120; 28793; 33944; 28799 |]; description= "Implants intended for Subcervical Processing Slot 5." } |> Some
