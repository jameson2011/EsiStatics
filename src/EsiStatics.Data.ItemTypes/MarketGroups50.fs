...
module internal MarketGroups50=
    let getMarketGroup id = 
      ...
      | 1408 -> { MarketGroupData.id= 1408; name= "Eyewear"; parentMarketGroupId= Some(1407); typeIds= [| 41575; 45745; 4037; 4038; 4039; 41576; 4009; 4042; 4043; 4046; 54966; 4048; 45736; 4050; 4052; 32853; 3958; 42905; 42906; 55005; 54965 |]; description= "Eyewear is almost exclusively used for vanity purposes given advances in modern cyberware that renders externally mounted hardware obsolete.  " } |> Some
      ...
      | 1990 -> { MarketGroupData.id= 1990; name= "Amarr"; parentMarketGroupId= Some(2028); typeIds= [| 49813; 56884; 47494; 47623; 53130; 42766; 42767; 42768; 42769; 44142; 53368; 44143; 55326; 55327; 55328; 53616; 55329; 53617; 54444; 53618; 36916; 57014; 52407; 46708; 42565; 42566; 42567; 42568; 47305; 45774; 45775; 45776; 45777; 48719; 48220; 56797; 57058; 54759; 34684; 43500; 43501; 43502; 43503; 44144; 44145; 41586; 53619; 34676; 34677; 34678; 34679; 34680; 34681; 34682; 34683; 37500; 37501; 37502; 37503 |]; description= "" } |> Some
      ...
      | 2281 -> { MarketGroupData.id= 2281; name= "Minmatar"; parentMarketGroupId= Some(2277); typeIds= [| 46149; 52902; 55653; 47178; 56935; 47052; 41685; 41686; 41687; 47646; 54437 |]; description= "" } |> Some
      | 2378 -> { MarketGroupData.id= 2378; name= "Faction Dreadnoughts"; parentMarketGroupId= Some(1971); typeIds= [|  |]; description= "" } |> Some
      | 2475 -> { MarketGroupData.id= 2475; name= "Implant Slot 07"; parentMarketGroupId= Some(2473); typeIds= [| 54536; 48746; 48747; 54534; 54535 |]; description= "Implant Slot 07" } |> Some
