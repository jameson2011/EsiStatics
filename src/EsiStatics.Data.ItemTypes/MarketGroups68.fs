...
module internal MarketGroups68=
    let getMarketGroup id = 
      ...
      | 2008 -> { MarketGroupData.id= 2008; name= "Caldari"; parentMarketGroupId= Some(2085); typeIds= [| 36673; 34754; 45863; 45864; 36745; 36746; 40621; 40622; 46140; 53200; 53201; 46867; 46868; 48206; 46753; 48207; 36674; 46141; 52638 |]; description= "" } |> Some
      | 2105 -> { MarketGroupData.id= 2105; name= "Caldari"; parentMarketGroupId= Some(2102); typeIds= [| 48192; 48193; 40610; 40611; 36356; 46853; 36358; 53186; 46126; 46127; 46854; 53187; 36662; 36663; 45849; 45850; 36734; 36735 |]; description= "" } |> Some
      ...
      | 353633 -> { MarketGroupData.id= 353633; name= "Skills"; parentMarketGroupId= Some(369234); typeIds= [|  |]; description= "Hardwired neural augmentations used to train new abilities" } |> Some
      ...
      | 364885 -> { MarketGroupData.id= 364885; name= "Basic"; parentMarketGroupId= Some(364044); typeIds= [|  |]; description= "Basic light frame dropsuits." } |> Some
      | 368668 -> { MarketGroupData.id= 368668; name= "Resources"; parentMarketGroupId= Some(368667); typeIds= [|  |]; description= "" } |> Some
