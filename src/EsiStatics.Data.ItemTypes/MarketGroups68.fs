...
module internal MarketGroups68=
    let getMarketGroup id = 
      ...
      | 2008 -> { MarketGroupData.id= 2008; name= "Caldari"; parentMarketGroupId= Some(2085); typeIds= [| 36745; 36746; 36674; 46867; 46868; 52638; 46753; 56866; 45863; 45864; 40621; 40622; 46140; 46141; 36673; 34754; 48206; 48207; 53200; 53201; 55515; 55516 |]; description= "" } |> Some
      | 2105 -> { MarketGroupData.id= 2105; name= "Caldari"; parentMarketGroupId= Some(2102); typeIds= [| 48192; 48193; 40610; 40611; 36356; 46853; 36358; 55559; 53186; 46126; 46127; 46854; 53187; 36662; 36663; 45849; 45850; 55567; 36734; 36735 |]; description= "" } |> Some
