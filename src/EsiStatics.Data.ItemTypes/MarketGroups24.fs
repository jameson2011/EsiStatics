...
module internal MarketGroups24=
    let getMarketGroup id = 
      ...
      | 1964 -> { MarketGroupData.id= 1964; name= "Amarr"; parentMarketGroupId= Some(1962); typeIds= [| 47493; 47625; 37515; 37516; 37517; 49817; 49818; 42784; 42785; 42786; 34599; 34600; 46378; 46535; 36913; 52407; 34623; 34624; 34625; 34626; 34627; 34628; 46534; 45793; 47307; 45794; 46802; 45795; 46804; 48854; 42584; 42585; 42586; 45665; 45666; 45667; 48893; 52392; 46803; 41588; 46710; 44280; 43515; 43516; 43517; 47102 |]; description= "" } |> Some
      | 2061 -> { MarketGroupData.id= 2061; name= "Gallente"; parentMarketGroupId= Some(2046); typeIds= [| 45883; 44900; 44901; 46935; 42158; 42159; 46934; 37558; 37559; 46395; 45882; 36379; 36380; 46394 |]; description= "" } |> Some
      | 2158 -> { MarketGroupData.id= 2158; name= ""; parentMarketGroupId= Some(2); typeIds= [|  |]; description= "" } |> Some
      ...
      | 353589 -> { MarketGroupData.id= 353589; name= "Electronics"; parentMarketGroupId= Some(353580); typeIds= [|  |]; description= "" } |> Some
      | 366199 -> { MarketGroupData.id= 366199; name= "Prototype"; parentMarketGroupId= Some(366174); typeIds= [|  |]; description= "" } |> Some
