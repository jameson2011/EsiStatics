...
module internal MarketGroups84=
    let getMarketGroup id = 
      ...
      | 2024 -> { MarketGroupData.id= 2024; name= "Amarr"; parentMarketGroupId= Some(2023); typeIds= [| 49947; 42788; 45797; 53639; 46536; 44127; 57069; 48214; 37519; 53008; 46806; 34810; 36319; 42588; 55350; 43519 |]; description= "" } |> Some
      ...
      | 2703 -> { MarketGroupData.id= 2703; name= "Precursor Dreadnoughts"; parentMarketGroupId= Some(1971); typeIds= [|  |]; description= "Precursor Dreadnoughts" } |> Some
