...
module internal MarketGroups75=
    let getMarketGroup id = 
      ...
      | 2112 -> { MarketGroupData.id= 2112; name= "Gallente"; parentMarketGroupId= Some(2109); typeIds= [| 45664; 46560; 44932; 42185; 36397; 37581; 46960; 47536; 45914; 52749; 46426 |]; description= "" } |> Some
      ...
      | 354416 -> { MarketGroupData.id= 354416; name= "Prototype"; parentMarketGroupId= Some(353576); typeIds= [|  |]; description= "" } |> Some
      | 364892 -> { MarketGroupData.id= 364892; name= "Prototype"; parentMarketGroupId= Some(364889); typeIds= [|  |]; description= "Prototype medium frames." } |> Some
      | 365280 -> { MarketGroupData.id= 365280; name= "Advanced"; parentMarketGroupId= Some(365278); typeIds= [|  |]; description= "Advanced commando dropsuits." } |> Some
      | 365765 -> { MarketGroupData.id= 365765; name= "Combat Rifles"; parentMarketGroupId= Some(364047); typeIds= [|  |]; description= "Combat Rifles." } |> Some
      | 366 -> { MarketGroupData.id= 366; name= "Drones"; parentMarketGroupId= Some(150); typeIds= [| 22541; 23566; 12305; 23069; 33699; 24613; 23594; 43702; 24241; 23606; 43703; 23618; 12484; 12485; 12486; 12487; 32339; 3436; 3437; 3438; 3439; 3440; 3441; 3442; 40572; 40573 |]; description= "Skills pertaining to the efficient operation of drones" } |> Some
