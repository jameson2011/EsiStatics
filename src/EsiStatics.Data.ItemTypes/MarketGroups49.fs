...
module internal MarketGroups49=
    let getMarketGroup id = 
      ...
      | 1407 -> { MarketGroupData.id= 1407; name= "Accessories"; parentMarketGroupId= Some(1396); typeIds= [| 54714; 54830 |]; description= "Apparel items that supplement an outfit by adding style and class" } |> Some
      ...
      | 2280 -> { MarketGroupData.id= 2280; name= "Gallente"; parentMarketGroupId= Some(2277); typeIds= [| 47051; 46148; 46443; 47537; 55602; 41684; 54443; 52439; 47644; 52766 |]; description= "" } |> Some
