...
module internal MarketGroups64=
    let getMarketGroup id = 
      ...
      | 2004 -> { MarketGroupData.id= 2004; name= "Gallente"; parentMarketGroupId= Some(2001); typeIds= [| 49799; 46386; 44174; 36367; 36368; 44177; 44178; 44179; 47503; 53209; 47631; 45875; 45871; 37552; 47522; 42147; 42148; 42149; 42150; 42151; 42152; 46387; 44891; 37547; 37548; 37549; 37550; 37551; 34736; 34737; 34738; 34739; 34740; 34741; 34742; 34743; 34744; 34745; 34746; 37055; 45876; 46388; 52706; 46384; 52707; 44889; 44890; 44175; 44892; 44893; 44894; 44176; 48226; 46563; 52708; 52709; 52710; 52711; 45872; 46385; 46383; 45560; 45874; 46717; 45873; 53375 |]; description= "" } |> Some
      ...
      | 2392 -> { MarketGroupData.id= 2392; name= "Minmatar"; parentMarketGroupId= Some(2309); typeIds= [| 52864; 45953; 53961; 52426; 46892; 48528 |]; description= "" } |> Some
      ...
      | 354696 -> { MarketGroupData.id= 354696; name= "Standard"; parentMarketGroupId= Some(354693); typeIds= [|  |]; description= "" } |> Some
      | 355181 -> { MarketGroupData.id= 355181; name= "Remote Explosives"; parentMarketGroupId= Some(353563); typeIds= [|  |]; description= "" } |> Some
      | 357121 -> { MarketGroupData.id= 357121; name= "Armor Hardeners"; parentMarketGroupId= Some(353588); typeIds= [|  |]; description= "" } |> Some
      | 364493 -> { MarketGroupData.id= 364493; name= "Advanced"; parentMarketGroupId= Some(364491); typeIds= [|  |]; description= "" } |> Some
