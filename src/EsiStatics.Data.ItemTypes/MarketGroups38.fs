...
module internal MarketGroups38=
    let getMarketGroup id = 
      ...
      | 1978 -> { MarketGroupData.id= 1978; name= "Amarr"; parentMarketGroupId= Some(2381); typeIds= [| 49824; 42594; 43523; 36293; 47639; 42794; 45803; 46540; 48367; 34672; 34673; 37523; 50071; 46711; 49432; 46812 |]; description= "" } |> Some
      | 2075 -> { MarketGroupData.id= 2075; name= "Gallente"; parentMarketGroupId= Some(2066); typeIds= [| 46944; 37569; 36386; 46410; 44916; 42172; 45898 |]; description= "" } |> Some
      ...
      | 366213 -> { MarketGroupData.id= 366213; name= "Standard"; parentMarketGroupId= Some(366189); typeIds= [|  |]; description= "" } |> Some
      | 367571 -> { MarketGroupData.id= 367571; name= "Agents"; parentMarketGroupId= Some(367570); typeIds= [|  |]; description= "" } |> Some
      | 369220 -> { MarketGroupData.id= 369220; name= "SKIN"; parentMarketGroupId= Some(365997); typeIds= [|  |]; description= "" } |> Some
      ...
      | 620 -> { MarketGroupData.id= 620; name= "Implant Slot 03"; parentMarketGroupId= Some(532); typeIds= [| 28800; 33921; 31958; 28806; 33927; 28812; 33933; 33808; 28818; 33939; 33945; 20506; 20507; 42202; 33951; 33563; 33957; 33393; 33963; 33969; 42206; 33975; 22715; 20158; 19536; 33528; 9942; 14296; 31972; 22111; 31966; 22117; 19553; 10212; 10213; 32105; 31978; 22123; 32111; 22129; 32116; 42212; 22136; 32121; 28794; 13285 |]; description= "Implants intended for Subcervical Processing Slot 3." } |> Some
