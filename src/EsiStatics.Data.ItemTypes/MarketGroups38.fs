...
module internal MarketGroups38=
    let getMarketGroup id = 
      ...
      | 1687 -> { MarketGroupData.id= 1687; name= "Layered Energized Armor Membranes"; parentMarketGroupId= Some(14); typeIds= [| 16423; 11235; 11237; 11239 |]; description= "Layered Energized Armor Membranes" } |> Some
      ...
      | 2754 -> { MarketGroupData.id= 2754; name= "Siege Module Mutaplasmids"; parentMarketGroupId= Some(2512); typeIds= [| 56299; 56300; 56301 |]; description= "Siege Module Mutaplasmids" } |> Some
      ...
      | 620 -> { MarketGroupData.id= 620; name= "Implant Slot 03"; parentMarketGroupId= Some(532); typeIds= [| 28800; 33921; 53892; 31958; 28806; 33927; 53898; 28812; 33933; 33808; 28818; 33939; 54406; 53904; 57112; 33945; 20506; 20507; 42202; 33951; 57119; 33563; 33957; 33393; 54400; 33963; 33969; 52787; 42206; 33975; 52921; 53855; 22715; 20158; 52680; 53708; 19536; 33528; 53715; 57125; 9942; 14296; 31972; 22111; 54394; 31966; 22117; 19553; 10212; 10213; 32105; 31978; 22123; 32111; 22129; 32116; 42212; 22136; 32121; 28794; 13285 |]; description= "Implants intended for Subcervical Processing Slot 3." } |> Some
