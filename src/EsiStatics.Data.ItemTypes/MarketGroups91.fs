...
module internal MarketGroups91=
    let getMarketGroup id = 
      ...
      | 1643 -> { MarketGroupData.id= 1643; name= "Salvage Drones"; parentMarketGroupId= Some(357); typeIds= [| 55763; 32982 |]; description= "Blueprints of salvage drone designs." } |> Some
