...
module internal MarketGroups31=
    let getMarketGroup id = 
      ...
      | 1680 -> { MarketGroupData.id= 1680; name= "Explosive Armor Hardeners"; parentMarketGroupId= Some(535); typeIds= [| 18951; 18967; 18959; 16365; 13974; 18905; 13976; 18925; 18975; 13988; 15270; 11303; 15272; 15274; 17504; 18889; 18891; 18927; 15064; 15268; 15066; 18907; 15068; 15709; 15070; 15072; 15074; 15076; 15717; 15078; 28524; 14061; 16367; 18937; 18939; 17834; 11646 |]; description= "Explosive Armor Hardeners" } |> Some
      ...
      | 2747 -> { MarketGroupData.id= 2747; name= "Proving Ground Filaments"; parentMarketGroupId= Some(2456); typeIds= [| 56353; 56092; 56093; 56094; 55983 |]; description= "Filaments that connect to the Abyssal Proving Grounds for limited time PVP events." } |> Some
      ...
      | 613 -> { MarketGroupData.id= 613; name= "Boost Amplifiers"; parentMarketGroupId= Some(552); typeIds= [| 20613; 16533; 16535; 15905; 15907; 11561; 14636; 14638; 14045; 14047; 19289; 19293; 19295; 19297; 19299; 19301; 19303; 19311; 14708; 14710; 14712; 14714; 24443 |]; description= "Focus and amplify the efficiency of shield boosting modules." } |> Some
