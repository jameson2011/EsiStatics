...
module internal MarketGroups31=
    let getMarketGroup id = 
      ...
      | 2747 -> { MarketGroupData.id= 2747; name= "Proving Ground Filaments"; parentMarketGroupId= Some(2456); typeIds= [| 55825; 55821; 55822; 55823 |]; description= "Filaments that connect to the Abyssal Proving Grounds for limited time PVP events." } |> Some
