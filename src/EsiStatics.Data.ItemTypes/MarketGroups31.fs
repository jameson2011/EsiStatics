...
module internal MarketGroups31=
    let getMarketGroup id = 
      ...
      | 2747 -> { MarketGroupData.id= 2747; name= "Proving Ground Filaments"; parentMarketGroupId= Some(2456); typeIds= [| 56353; 56354; 56355; 56094 |]; description= "Filaments that connect to the Abyssal Proving Grounds for limited time PVP events." } |> Some
