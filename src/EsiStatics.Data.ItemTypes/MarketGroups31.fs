...
module internal MarketGroups31=
    let getMarketGroup id = 
      ...
      | 2747 -> { MarketGroupData.id= 2747; name= "Proving Ground Filaments"; parentMarketGroupId= Some(2456); typeIds= [| 56360; 56361; 56358; 56359 |]; description= "Filaments that connect to the Abyssal Proving Grounds for limited time PVP events." } |> Some
