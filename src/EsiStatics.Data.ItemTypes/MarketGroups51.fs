...
module internal MarketGroups51=
    let getMarketGroup id = 
      ...
      | 1506 -> { MarketGroupData.id= 1506; name= "Implant Slot 06"; parentMarketGroupId= Some(1472); typeIds= [| 28801; 33922; 28807; 33928; 28813; 33934; 28819; 33940; 33946; 20508; 20509; 33952; 33958; 33964; 33565; 33970; 33976; 20161; 52683; 33529; 19539; 31959; 42203; 31967; 22112; 42209; 28795; 19556; 31973; 22118; 42215; 31979; 22124; 22130; 22137; 32122; 32123; 32124; 32125 |]; description= "Implant Slot 06" } |> Some
      ...
      | 1991 -> { MarketGroupData.id= 1991; name= "Caldari"; parentMarketGroupId= Some(2028); typeIds= [| 34688; 45833; 45834; 45835; 45836; 40597; 40598; 40599; 40600; 52633; 52636; 52637; 46110; 46111; 46112; 46113; 36649; 36650; 36651; 36652; 52399; 48176; 48177; 48178; 48179; 46729; 47499; 40772; 41421; 47311; 48720; 45014; 48224; 47612; 34685; 36721; 36722; 36723; 36724; 34686; 46713; 34687; 44156; 44157; 44158; 44159 |]; description= "" } |> Some
      | 2088 -> { MarketGroupData.id= 2088; name= "Amarr"; parentMarketGroupId= Some(2087); typeIds= [| 46816; 48859; 42597; 42598; 43527; 43526; 52587; 36300; 36301; 42798; 42797; 45806; 37526; 37527; 46745; 46746; 45807; 48860; 52586; 46815 |]; description= "" } |> Some
