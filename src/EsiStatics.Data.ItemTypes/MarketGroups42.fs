...
module internal MarketGroups42=
    let getMarketGroup id = 
      ...
      | 2079 -> { MarketGroupData.id= 2079; name= "Gallente"; parentMarketGroupId= Some(2067); typeIds= [| 36384; 46945; 37570; 45899; 54442; 46411; 44917; 42173; 52734; 48725 |]; description= "" } |> Some
      ...
      | 2370 -> { MarketGroupData.id= 2370; name= "Caldari"; parentMarketGroupId= Some(2369); typeIds= [| 48544; 46024; 45997; 52303; 48816; 46120; 45843; 48186; 48543; 53180; 46847 |]; description= "" } |> Some
