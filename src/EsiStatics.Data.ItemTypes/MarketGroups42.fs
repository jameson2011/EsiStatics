...
module internal MarketGroups42=
    let getMarketGroup id = 
      ...
      | 1691 -> { MarketGroupData.id= 1691; name= "EM Shield Amplifiers"; parentMarketGroupId= Some(550); typeIds= [| 19231; 19247; 20611; 14630; 1798; 14634; 19223; 9580; 15917; 19215; 1808; 19255; 14740; 14742; 14041; 14744; 2553; 14746; 14043; 19245; 15909 |]; description= "EM Shield Amplifiers" } |> Some
      ...
      | 1982 -> { MarketGroupData.id= 1982; name= "Gallente"; parentMarketGroupId= Some(2377); typeIds= [| 36395; 45572; 34663; 34664; 42187; 37583; 44936; 46964; 46430; 52753; 46557; 45918; 55592 |]; description= "" } |> Some
      | 2079 -> { MarketGroupData.id= 2079; name= "Gallente"; parentMarketGroupId= Some(2067); typeIds= [| 36384; 46945; 37570; 45899; 54442; 46411; 55634; 44917; 42173; 52734; 48725 |]; description= "" } |> Some
      ...
      | 2370 -> { MarketGroupData.id= 2370; name= "Caldari"; parentMarketGroupId= Some(2369); typeIds= [| 48544; 46024; 45997; 52303; 48816; 46120; 45843; 55513; 48186; 48543; 53180; 46847 |]; description= "" } |> Some
