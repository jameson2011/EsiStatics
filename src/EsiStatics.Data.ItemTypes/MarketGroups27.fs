...
module internal MarketGroups27=
    let getMarketGroup id = 
      ...
      | 1967 -> { MarketGroupData.id= 1967; name= "Minmatar"; parentMarketGroupId= Some(1962); typeIds= [| 48896; 48514; 48515; 48516; 46725; 52886; 54800; 47505; 48530; 52884; 45973; 45974; 45975; 53017; 49157; 53142; 56889; 49959; 46380; 36782; 36783; 36784; 40500; 40501; 40502; 52404; 46910; 46911; 46912; 57025; 47171; 47173; 57162; 40695; 55714; 34641; 34642; 34643; 47319; 36829; 36830; 36831; 56928; 56932; 55654; 55655; 47638; 57067; 55663; 53360; 45559; 34808; 34809; 52885 |]; description= "" } |> Some
      ...
      | 2355 -> { MarketGroupData.id= 2355; name= "Minmatar"; parentMarketGroupId= Some(2307); typeIds= [| 44160; 55642; 45932 |]; description= "" } |> Some
      ...
      | 2743 -> { MarketGroupData.id= 2743; name= "Medium"; parentMarketGroupId= Some(2741); typeIds= [| 54745; 54746; 54747; 54748; 54749 |]; description= "" } |> Some
      ...
      | 609 -> { MarketGroupData.id= 609; name= "Small"; parentMarketGroupId= Some(552); typeIds= [| 13952; 19169; 19171; 6437; 32774; 19175; 6441; 19177; 399; 400; 19173; 19179; 10039; 20617; 15898; 15902; 13951 |]; description= "Frigate-class shield boosters." } |> Some
