...
module internal MarketGroups58=
    let getMarketGroup id = 
      ...
      | 1513 -> { MarketGroupData.id= 1513; name= ""; parentMarketGroupId= Some(1470); typeIds= [| 3288; 3289; 3290; 13232; 13235; 13236; 3271; 3272; 3273; 3280; 3281; 3282; 3283; 3284; 3287; 27224; 27225; 27226; 27232; 27233; 27234; 27235; 27236; 27237 |]; description= "" } |> Some
      ...
      | 354690 -> { MarketGroupData.id= 354690; name= "Standard"; parentMarketGroupId= Some(354686); typeIds= [|  |]; description= "" } |> Some
      | 355466 -> { MarketGroupData.id= 355466; name= "Dropsuit Modules"; parentMarketGroupId= Some(355459); typeIds= [|  |]; description= "" } |> Some
      | 356436 -> { MarketGroupData.id= 356436; name= "Prototype"; parentMarketGroupId= Some(356433); typeIds= [|  |]; description= "" } |> Some
      ...
      | 834 -> { MarketGroupData.id= 834; name= ""; parentMarketGroupId= Some(822); typeIds= [| 22468; 22444 |]; description= "" } |> Some
