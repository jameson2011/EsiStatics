...
module internal MarketGroups57=
    let getMarketGroup id = 
      ...
      | 1997 -> { MarketGroupData.id= 1997; name= "Minmatar"; parentMarketGroupId= Some(2035); typeIds= [| 35586; 44167; 44168; 48527; 53144; 34714; 34715; 36764; 36765; 53535; 40480; 40481; 52406; 53310; 36811; 36812; 48231; 52861; 53362; 52860; 45949; 45950 |]; description= "" } |> Some
      ...
      | 2482 -> { MarketGroupData.id= 2482; name= "Triglavian"; parentMarketGroupId= Some(2481); typeIds= [| 50145; 52323; 49928; 48651; 50156; 48655; 48565 |]; description= "Triglavian Battleships" } |> Some
      | 355465 -> { MarketGroupData.id= 355465; name= "Turrets"; parentMarketGroupId= Some(355460); typeIds= [|  |]; description= "" } |> Some
      | 356435 -> { MarketGroupData.id= 356435; name= "Advanced"; parentMarketGroupId= Some(356433); typeIds= [|  |]; description= "" } |> Some
