...
module internal MarketGroups78=
    let getMarketGroup id = 
      ...
      | 1533 -> { MarketGroupData.id= 1533; name= "Sentry Drones"; parentMarketGroupId= Some(1530); typeIds= [| 23560; 23562; 23564; 23526 |]; description= "Blueprints of sentry drone designs." } |> Some
