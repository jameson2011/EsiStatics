...
module internal MarketGroups70=
    let getMarketGroup id = 
      ...
      | 1234 -> { MarketGroupData.id= 1234; name= ""; parentMarketGroupId= Some(965); typeIds= [| 31776; 31746; 31716; 31782; 31752; 31722; 31788; 31810; 31758; 31728; 31816; 31794; 31764; 31822; 31734; 31800; 31770; 31740 |]; description= "" } |> Some
      ...
      | 2010 -> { MarketGroupData.id= 2010; name= "Minmatar"; parentMarketGroupId= Some(2085); typeIds= [| 46747; 52895; 45984; 45985; 45986; 36791; 36792; 36793; 40509; 40510; 40511; 52896; 34757; 52897; 46921; 46922; 46923; 36838; 36839; 36840; 55657; 55658; 55662 |]; description= "" } |> Some
      | 2107 -> { MarketGroupData.id= 2107; name= "Minmatar"; parentMarketGroupId= Some(2102); typeIds= [| 55688; 52881; 45970; 45971; 52882; 55712; 49958; 36780; 36781; 40498; 40499; 46907; 46908; 47169; 52431; 52304; 36827; 36828; 36446; 36448; 55698; 48819 |]; description= "" } |> Some
