...
module internal DogmaAttributes89=
    let getDogmaAttribute id = 
      ...
      | 3096 -> { DogmaAttributeData.id= 3096; name= "locationListID"; description= ""; published= false; unitId= None; defaultValue= 0.000000; stackable= false; highIsGood= false } |> Some
