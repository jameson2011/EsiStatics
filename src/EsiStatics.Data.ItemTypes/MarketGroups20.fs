...
module internal MarketGroups20=
    let getMarketGroup id = 
      ...
      | 1669 -> { MarketGroupData.id= 1669; name= "Layered Armor Coatings"; parentMarketGroupId= Some(14); typeIds= [| 1272; 16345; 1274; 1276 |]; description= "Layered Armor Coatings" } |> Some
      ...
      | 1863 -> { MarketGroupData.id= 1863; name= "Salvaged Materials"; parentMarketGroupId= Some(1861); typeIds= [| 25600; 25601; 25602; 25603; 25604; 25605; 25606; 25607; 25608; 25609; 25610; 25611; 25612; 25613; 25614; 25615; 25616; 25617; 25618; 25619; 25620; 25621; 25622; 25623; 25624; 25625; 54970; 54971; 54972; 25588; 25589; 25590; 25591; 25592; 25593; 25594; 25595; 25596; 25597; 25598; 25599 |]; description= "Materials salvaged from destroyed starships." } |> Some
      | 1960 -> { MarketGroupData.id= 1960; name= "Battleships"; parentMarketGroupId= Some(1954); typeIds= [|  |]; description= "" } |> Some
      | 20 -> { MarketGroupData.id= 20; name= "Industrial Goods"; parentMarketGroupId= Some(19); typeIds= [| 41024; 33539; 56708; 56709; 56710; 41025; 40456; 56713; 56714; 17893; 56711; 12302; 41027; 41028; 41029; 30497; 41; 53291; 16686; 56712; 53299; 3643; 56715; 3773; 41023; 2368; 2369; 41026; 2371; 11588; 2373; 2374; 2375; 2376; 2377; 40549; 40548; 56716; 17894; 3685; 9826; 15331; 3812; 3771; 3814; 3687; 17897; 17895; 53476; 15353; 40701 |]; description= "Various products used in a variety of industries" } |> Some
      | 2057 -> { MarketGroupData.id= 2057; name= "Gallente"; parentMarketGroupId= Some(2045); typeIds= [| 44899; 52716; 42157; 37557; 45881; 46393; 36378; 55614; 46933 |]; description= "" } |> Some
      ...
      | 2736 -> { MarketGroupData.id= 2736; name= "Large"; parentMarketGroupId= Some(2729); typeIds= [| 54777; 54778; 54779; 54780 |]; description= "" } |> Some
      ...
      | 699 -> { MarketGroupData.id= 699; name= "Small"; parentMarketGroupId= Some(668); typeIds= [| 15780; 14184; 14186; 20555; 3566; 3568; 5011; 15772; 23807 |]; description= "Frigate-sized capacitor boosters." } |> Some
