...
module internal DogmaAttributes92=
    let getDogmaAttribute id = 
      ...
      | 3099 -> { DogmaAttributeData.id= 3099; name= "shieldBoosterDurationBonus"; description= ""; published= false; unitId= None; defaultValue= 0.000000; stackable= false; highIsGood= false } |> Some
