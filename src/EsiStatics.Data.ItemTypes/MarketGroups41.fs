...
module internal MarketGroups41=
    let getMarketGroup id = 
      ...
      | 1981 -> { MarketGroupData.id= 1981; name= "Caldari"; parentMarketGroupId= Some(2377); typeIds= [| 45859; 36741; 34662; 40617; 48202; 53196; 46863; 47314; 52563; 46136; 46716; 36669; 48734; 34661 |]; description= "" } |> Some
      | 2078 -> { MarketGroupData.id= 2078; name= "Caldari"; parentMarketGroupId= Some(2067); typeIds= [| 45840; 46117; 54439; 46844; 48183; 52557; 36656; 48724; 36343; 36728; 53177; 50075; 40604 |]; description= "" } |> Some
