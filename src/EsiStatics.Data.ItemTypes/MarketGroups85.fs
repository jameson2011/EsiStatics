...
module internal MarketGroups85=
    let getMarketGroup id = 
      ...
      | 1346 -> { MarketGroupData.id= 1346; name= "Jump Bridge"; parentMarketGroupId= Some(1841); typeIds= [|  |]; description= "Blueprints of Jump Bridge." } |> Some
      ...
      | 2025 -> { MarketGroupData.id= 2025; name= "Caldari"; parentMarketGroupId= Some(2023); typeIds= [| 45856; 47619; 36740; 48199; 40616; 36361; 46860; 46733; 57070; 49423; 52560; 55550; 53011; 46133; 53193; 36668; 48733; 34814 |]; description= "" } |> Some
      ...
      | 2704 -> { MarketGroupData.id= 2704; name= "Triglavian"; parentMarketGroupId= Some(2703); typeIds= [| 53668; 54222 |]; description= "Triglavian Dreadnoughts" } |> Some
