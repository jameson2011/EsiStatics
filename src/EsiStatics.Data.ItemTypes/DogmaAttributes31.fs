...
module internal DogmaAttributes31=
    let getDogmaAttribute id = 
      ...
      | 3038 -> { DogmaAttributeData.id= 3038; name= "isCynoJammer"; description= "Referenced by code to know that cynosural fields will fail in the same park as this type"; published= false; unitId= None; defaultValue= 0.000000; stackable= false; highIsGood= false } |> Some
