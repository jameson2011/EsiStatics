...
module internal MarketGroups81=
    let getMarketGroup id = 
      ...
      | 1342 -> { MarketGroupData.id= 1342; name= "Cynosural Generator Arrays"; parentMarketGroupId= Some(1841); typeIds= [| 2788 |]; description= "Blueprints of Cynosural Generator Arrays." } |> Some
      ...
      | 354616 -> { MarketGroupData.id= 354616; name= "Mass Drivers"; parentMarketGroupId= Some(364047); typeIds= [|  |]; description= "Mass drivers." } |> Some
      | 365771 -> { MarketGroupData.id= 365771; name= "Advanced"; parentMarketGroupId= Some(365769); typeIds= [|  |]; description= "Advanced." } |> Some
      | 366741 -> { MarketGroupData.id= 366741; name= "Ion Pistols"; parentMarketGroupId= Some(364048); typeIds= [|  |]; description= "Ion Pistols." } |> Some
