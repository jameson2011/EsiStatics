...
module internal DogmaEffects53=
    let getDogmaEffect id = 
      ...
      | 7231 -> { DogmaEffectData.id= 7231; name= "shipBonusArmorRepAmountGC3"; description= "Automatically generated effect"; displayName= ""; effectCategory= 0; preExpression= 17382; postExpression= 17383 } |> Some
