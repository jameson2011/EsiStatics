...
module internal MarketGroups87=
    let getMarketGroup id = 
      ...
      | 2027 -> { MarketGroupData.id= 2027; name= "Minmatar"; parentMarketGroupId= Some(2023); typeIds= [| 36833; 46914; 48518; 47176; 55689; 48522; 56914; 52432; 52888; 36786; 45977; 40504; 35705; 57072 |]; description= "" } |> Some
      ...
      | 2706 -> { MarketGroupData.id= 2706; name= "Jump Filaments"; parentMarketGroupId= Some(2456); typeIds= [| 53984; 53985; 53986; 53987; 53977; 53330; 53331; 53332; 53333; 53334; 53335; 53336; 53337; 53338; 53983 |]; description= "Filaments that jump fleets unpredictably to other locations in known space." } |> Some
