...
module internal MarketGroups13=
    let getMarketGroup id = 
      ...
      | 2050 -> { MarketGroupData.id= 2050; name= "Minmatar"; parentMarketGroupId= Some(2043); typeIds= [| 55683; 36757; 36758; 40473; 40474; 46880; 46881; 45939; 36804; 36805; 56902; 52423; 52424; 36427; 36429; 56909; 48491; 48492; 52850; 52851; 45940; 55676 |]; description= "" } |> Some
      ...
      | 2729 -> { MarketGroupData.id= 2729; name= "Standard Condenser Packs"; parentMarketGroupId= Some(2728); typeIds= [|  |]; description= "Standard Condenser Packs" } |> Some
