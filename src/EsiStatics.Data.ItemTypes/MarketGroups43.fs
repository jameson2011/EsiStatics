...
module internal MarketGroups43=
    let getMarketGroup id = 
      ...
      | 1983 -> { MarketGroupData.id= 1983; name= "Minmatar"; parentMarketGroupId= Some(2377); typeIds= [| 46016; 36834; 46917; 34665; 48523; 52433; 36787; 45558; 47320; 40505; 52891; 45980 |]; description= "" } |> Some
      | 2080 -> { MarketGroupData.id= 2080; name= "Minmatar"; parentMarketGroupId= Some(2067); typeIds= [| 54436; 36774; 52872; 45961; 40491; 36432; 46898; 36821; 48726; 48508; 47166 |]; description= "" } |> Some
      ...
      | 2371 -> { MarketGroupData.id= 2371; name= "Amarr"; parentMarketGroupId= Some(2369); typeIds= [| 45784; 46793; 53626; 46022 |]; description= "" } |> Some
