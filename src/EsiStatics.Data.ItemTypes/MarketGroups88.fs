...
module internal MarketGroups88=
    let getMarketGroup id = 
      ...
      | 1543 -> { MarketGroupData.id= 1543; name= "Energized Plating"; parentMarketGroupId= Some(214); typeIds= [| 11268; 11238; 11248; 11218; 11258; 11228; 46013 |]; description= "Blueprints for Energized Plating" } |> Some
