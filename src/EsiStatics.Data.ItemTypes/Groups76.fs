...
module internal Groups76=
    let getGroup id = 
      ...
      | 4053 -> { GroupData.id= 4053; name= "Irregular Capsule"; categoryId= 11; published= false; typeIds= [| 54233; 54240; 54241; 54242; 54243; 54244 |] } |> Some
      | 464 -> { GroupData.id= 464; name= "Strip Miner"; categoryId= 7; published= true; typeIds= [| 16278; 17482; 22229; 28752; 28754; 54658 |] } |> Some
