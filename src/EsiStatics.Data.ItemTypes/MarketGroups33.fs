...
module internal MarketGroups33=
    let getMarketGroup id = 
      ...
      | 1682 -> { MarketGroupData.id= 1682; name= "Energized Explosive Plating"; parentMarketGroupId= Some(541); typeIds= [| 15232; 14082; 14084; 14086; 18823; 14984; 14986; 18839; 14988; 15234; 14990; 14992; 16401; 14994; 16403; 14996; 16405; 14998; 16407; 17540; 18857; 18859; 18873; 18875; 11225; 11227; 11229; 15725; 18803; 15735; 28538; 15228; 18813; 15230; 18837 |]; description= "Energized Explosive Plating" } |> Some
      ...
      | 2070 -> { MarketGroupData.id= 2070; name= "Caldari"; parentMarketGroupId= Some(2065); typeIds= [| 47105; 46730; 47628; 45837; 45838; 40601; 40602; 54428; 50074; 49953; 46114; 46115; 52634; 36653; 36654; 53425; 48180; 48181; 53174; 53175; 48833; 53956; 52555; 52558; 36346; 36725; 36726; 36344; 46841; 46842; 47614 |]; description= "" } |> Some
      ...
      | 2361 -> { MarketGroupData.id= 2361; name= "Special Covert Ops"; parentMarketGroupId= Some(2044); typeIds= [| 47680; 48576; 48579; 46021; 45991; 54216; 45481; 47001 |]; description= "" } |> Some
      | 2458 -> { MarketGroupData.id= 2458; name= "Dark Filaments"; parentMarketGroupId= Some(2456); typeIds= [| 47762; 47892; 47893; 47894; 47895 |]; description= "Filaments that connect to Abyssal pockets with Dark Matter Fields" } |> Some
      | 354471 -> { MarketGroupData.id= 354471; name= "Shield Boosters"; parentMarketGroupId= Some(353587); typeIds= [|  |]; description= "" } |> Some
      | 366111 -> { MarketGroupData.id= 366111; name= "Contact Grenades"; parentMarketGroupId= Some(353557); typeIds= [|  |]; description= "Contact Grenades." } |> Some
      | 366208 -> { MarketGroupData.id= 366208; name= "Prototype"; parentMarketGroupId= Some(366177); typeIds= [|  |]; description= "" } |> Some
      | 367566 -> { MarketGroupData.id= 367566; name= "Special Offers"; parentMarketGroupId= Some(350001); typeIds= [|  |]; description= "" } |> Some
      | 369215 -> { MarketGroupData.id= 369215; name= "Skins"; parentMarketGroupId= Some(369214); typeIds= [|  |]; description= "" } |> Some
      ...
      | 518 -> { MarketGroupData.id= 518; name= "Veldspar"; parentMarketGroupId= Some(54); typeIds= [| 46689; 50015; 28430; 28431; 28432; 46705; 48916; 1230; 49787; 49789; 17470; 17471 |]; description= "Sub-types of veldspar ore.   " } |> Some
