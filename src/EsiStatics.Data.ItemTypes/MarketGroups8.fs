...
module internal MarketGroups8=
    let getMarketGroup id = 
      ...
      | 1366 -> { MarketGroupData.id= 1366; name= "Navy Faction"; parentMarketGroupId= Some(1362); typeIds= [| 17703; 54731; 33677; 37454; 37453; 37456; 17841; 17619; 17812; 37455 |]; description= "Navy faction frigate designs." } |> Some
      ...
      | 2142 -> { MarketGroupData.id= 2142; name= "Amarr"; parentMarketGroupId= Some(2141); typeIds= [| 46784; 42562; 43498; 45771; 42764; 53613; 55354; 52575; 40319 |]; description= "" } |> Some
      ...
      | 2530 -> { MarketGroupData.id= 2530; name= "Booster Slot 12"; parentMarketGroupId= Some(977); typeIds= [|  |]; description= "" } |> Some
