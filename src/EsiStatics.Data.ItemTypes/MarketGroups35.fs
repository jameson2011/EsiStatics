...
module internal MarketGroups35=
    let getMarketGroup id = 
      ...
      | 1975 -> { MarketGroupData.id= 1975; name= "Caldari"; parentMarketGroupId= Some(2374); typeIds= [| 36742; 36359; 47497; 47630; 46864; 46865; 52642; 45860; 45861; 40618; 40619; 53426; 46137; 46138; 47291; 36670; 36671; 46277; 48203; 48204; 53197; 53198; 47315; 36743; 34651; 34652; 49424 |]; description= "" } |> Some
      | 2072 -> { MarketGroupData.id= 2072; name= "Minmatar"; parentMarketGroupId= Some(2065); typeIds= [| 52869; 45958; 45959; 47636; 36771; 36772; 52870; 40488; 40489; 46895; 46896; 53432; 47162; 46019; 53962; 52427; 36433; 36818; 36435; 36819; 48505; 48506 |]; description= "" } |> Some
      ...
      | 353600 -> { MarketGroupData.id= 353600; name= "Scout"; parentMarketGroupId= Some(364044); typeIds= [|  |]; description= "Scout dropsuits." } |> Some
      | 354376 -> { MarketGroupData.id= 354376; name= "Standard"; parentMarketGroupId= Some(353601); typeIds= [|  |]; description= "" } |> Some
      | 366113 -> { MarketGroupData.id= 366113; name= "Advanced"; parentMarketGroupId= Some(366111); typeIds= [|  |]; description= "Advanced." } |> Some
      | 366210 -> { MarketGroupData.id= 366210; name= "Standard"; parentMarketGroupId= Some(366186); typeIds= [|  |]; description= "" } |> Some
      | 369217 -> { MarketGroupData.id= 369217; name= "APEX"; parentMarketGroupId= Some(369216); typeIds= [|  |]; description= "" } |> Some
