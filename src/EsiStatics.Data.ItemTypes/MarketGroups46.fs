...
module internal MarketGroups46=
    let getMarketGroup id = 
      ...
      | 1986 -> { MarketGroupData.id= 1986; name= "Gallente"; parentMarketGroupId= Some(1972); typeIds= [| 45929; 36396; 34669; 34670; 45581; 44947; 42198; 46441; 37594; 46974; 46559 |]; description= "" } |> Some
      | 2083 -> { MarketGroupData.id= 2083; name= "Gallente"; parentMarketGroupId= Some(2068); typeIds= [| 46946; 37571; 37572; 46412; 45900; 45901; 46413; 46947; 36382; 44918; 44919; 36383; 42174; 42175 |]; description= "" } |> Some
      ...
      | 366221 -> { MarketGroupData.id= 366221; name= ""; parentMarketGroupId= Some(366181); typeIds= [|  |]; description= "" } |> Some
