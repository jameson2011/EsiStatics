...
module internal MarketGroups21=
    let getMarketGroup id = 
      ...
      | 1379 -> { MarketGroupData.id= 1379; name= "Navy Faction"; parentMarketGroupId= Some(1378); typeIds= [| 17728; 17732; 54733; 32305; 32307; 32309; 32311; 17636; 17726 |]; description= "Navy faction battleship designs." } |> Some
      ...
      | 1670 -> { MarketGroupData.id= 1670; name= "Multispectrum Coatings"; parentMarketGroupId= Some(540); typeIds= [| 1302; 14856; 14858; 14860; 17549; 14862; 14864; 14866; 14868; 14870; 1304; 1306; 16305; 18704; 13999; 14001; 14003; 15164; 15166; 15168; 15170; 18700; 15693; 18768; 18702; 15703; 18779; 14556; 14560; 14049; 18710; 18789; 28520; 17514; 18706; 18708 |]; description= "Multispectrum Coatings" } |> Some
      ...
      | 2737 -> { MarketGroupData.id= 2737; name= "Small"; parentMarketGroupId= Some(2730); typeIds= [| 54784; 54781 |]; description= "" } |> Some
      ...
      | 700 -> { MarketGroupData.id= 700; name= "Medium"; parentMarketGroupId= Some(668); typeIds= [| 14176; 577; 14178; 4833; 2024; 23809; 20557; 15784; 15776 |]; description= "Cruiser-sized capacitor boosters." } |> Some
