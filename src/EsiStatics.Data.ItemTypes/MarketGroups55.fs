...
module internal MarketGroups55=
    let getMarketGroup id = 
      ...
      | 1995 -> { MarketGroupData.id= 1995; name= "Caldari"; parentMarketGroupId= Some(2035); typeIds= [| 47610; 35074; 48171; 45828; 40774; 36646; 36647; 48223; 46727; 48172; 36718; 36719; 40593; 40594; 45013; 48727; 46105; 44154; 44155; 46106; 45829 |]; description= "" } |> Some
      ...
      | 2480 -> { MarketGroupData.id= 2480; name= "Triglavian Data"; parentMarketGroupId= Some(19); typeIds= [| 48768; 48769; 48770; 48771; 48772; 52192; 48774; 48775; 48777; 48778; 52195; 52196; 48121; 52197; 52191; 48764; 48765; 52190; 48767 |]; description= "Data found in Abyssal Deadspace" } |> Some
