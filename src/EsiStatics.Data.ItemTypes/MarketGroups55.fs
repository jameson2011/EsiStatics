...
module internal MarketGroups55=
    let getMarketGroup id = 
      ...
      | 1995 -> { MarketGroupData.id= 1995; name= "Caldari"; parentMarketGroupId= Some(2035); typeIds= [| 35074; 45828; 45829; 46727; 53136; 40593; 40594; 52631; 46105; 46106; 54556; 53538; 36646; 36647; 48171; 48172; 53165; 53166; 57053; 52402; 53308; 40774; 52553; 45013; 48727; 44154; 48223; 36718; 36719; 55540; 55541; 47610; 44155; 53372 |]; description= "" } |> Some
      | 2092 -> { MarketGroupData.id= 2092; name= "Caldari"; parentMarketGroupId= Some(2381); typeIds= [| 36672; 55520; 52643; 45862; 36744; 56956; 40620; 48205; 36334; 53199; 49425; 46866; 53427; 53012; 55726; 47641; 46139; 50076 |]; description= "" } |> Some
      ...
      | 2480 -> { MarketGroupData.id= 2480; name= "Triglavian Data"; parentMarketGroupId= Some(19); typeIds= [| 48768; 48769; 48770; 48771; 48772; 55830; 48774; 48775; 48777; 48778; 54804; 54805; 54806; 55831; 55832; 52408; 52409; 52410; 52411; 52412; 52413; 52190; 52191; 52192; 52195; 52196; 52197; 48121; 48764; 48765; 48767 |]; description= "Triglavian Data Storage Devices" } |> Some
      ...
      | 540 -> { MarketGroupData.id= 540; name= "Armor Resistance Coatings"; parentMarketGroupId= Some(14); typeIds= [|  |]; description= "Armor Resistance Coatings" } |> Some
