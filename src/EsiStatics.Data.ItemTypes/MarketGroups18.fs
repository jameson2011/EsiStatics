...
module internal MarketGroups18=
    let getMarketGroup id = 
      ...
      | 1958 -> { MarketGroupData.id= 1958; name= "Gallente"; parentMarketGroupId= Some(2101); typeIds= [| 52397; 47633; 36376; 39584; 49956; 47533; 48558; 34611; 34612; 34614; 34615; 34616; 34617; 52283; 35006; 42177; 42178; 42179; 48836; 37573; 37574; 37575; 46417; 45906; 45907; 52436; 48229; 45905; 46952; 46953; 46951; 46418; 50031; 46419; 44923; 44924; 44925; 46719 |]; description= "" } |> Some
      | 2055 -> { MarketGroupData.id= 2055; name= "Amarr"; parentMarketGroupId= Some(2045); typeIds= [| 36290; 45763; 43492; 37494; 42756; 42554; 46778 |]; description= "" } |> Some
      ...
      | 353583 -> { MarketGroupData.id= 353583; name= "Biotics"; parentMarketGroupId= Some(353579); typeIds= [|  |]; description= "" } |> Some
      | 356978 -> { MarketGroupData.id= 356978; name= "Prototype"; parentMarketGroupId= Some(354483); typeIds= [|  |]; description= "" } |> Some
      | 365999 -> { MarketGroupData.id= 365999; name= "State Peacekeepers"; parentMarketGroupId= Some(365995); typeIds= [|  |]; description= "The Caldari store contains items that require loyalty points from the State Peacekeepers." } |> Some
      | 366193 -> { MarketGroupData.id= 366193; name= "Dropsuit Modules"; parentMarketGroupId= Some(365998); typeIds= [|  |]; description= "" } |> Some
      ...
      | 697 -> { MarketGroupData.id= 697; name= "Large"; parentMarketGroupId= Some(663); typeIds= [| 12225; 16483; 16485; 12102; 16487; 31946; 23856; 16481 |]; description= "Battleship-sized energy transfer arrays." } |> Some
