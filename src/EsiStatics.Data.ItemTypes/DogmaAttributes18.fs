...
module internal DogmaAttributes18=
    let getDogmaAttribute id = 
      ...
      | 2831 -> { DogmaAttributeData.id= 2831; name= "shipBonusDreadnoughtPC3"; description= ""; published= false; unitId= None; defaultValue= 0.000000; stackable= true; highIsGood= true } |> Some
      | 3025 -> { DogmaAttributeData.id= 3025; name= "ActiveSystemJump"; description= ""; published= false; unitId= None; defaultValue= 0.000000; stackable= false; highIsGood= false } |> Some
