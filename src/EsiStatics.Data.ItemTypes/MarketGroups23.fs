...
module internal MarketGroups23=
    let getMarketGroup id = 
      ...
      | 1963 -> { MarketGroupData.id= 1963; name= "Pirate Faction"; parentMarketGroupId= Some(1961); typeIds= [| 54912; 46977; 47106; 54913; 54921; 47511; 43535; 47377; 48146; 47251; 44949; 46999; 49434; 46875; 47005; 47008; 56603; 47015; 48554; 49963; 45485; 53021; 50035; 47029; 47030; 52596; 46522; 44220; 53438; 47295; 45509; 53960; 37967; 54231; 46042; 45020; 44255; 52705; 45668; 46821; 37869; 50034; 48147; 35700; 54904; 56954; 53951; 56957; 49150 |]; description= "" } |> Some
      | 2060 -> { MarketGroupData.id= 2060; name= "Caldari"; parentMarketGroupId= Some(2046); typeIds= [| 45824; 55555; 55562; 47627; 40590; 40591; 46100; 46101; 36644; 36645; 48166; 48167; 53160; 53161; 57006; 36716; 36717; 36335; 36336; 46833; 46834; 45823 |]; description= "" } |> Some
      ...
      | 2739 -> { MarketGroupData.id= 2739; name= "Large"; parentMarketGroupId= Some(2730); typeIds= [| 54782; 54783 |]; description= "" } |> Some
      ...
      | 799 -> { MarketGroupData.id= 799; name= "Fleet Assistance Modules"; parentMarketGroupId= Some(209); typeIds= [| 21604; 28647; 28653; 43544; 23954; 52695; 23736; 43545; 43546; 43547; 43548; 56734 |]; description= "Blueprints of Fleet Assistance Modules." } |> Some
