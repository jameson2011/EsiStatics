...
module internal DogmaEffects74=
    let getDogmaEffect id = 
      match id with 
      | 1141 -> { DogmaEffectData.id= 1141; name= "shipHybridTrackingGD2"; description= ""; displayName= ""; effectCategory= 0; preExpression= 4979; postExpression= 4980 } |> Some
      | 1238 -> { DogmaEffectData.id= 1238; name= "shipLaserCapPirateBattleship"; description= ""; displayName= ""; effectCategory= 0; preExpression= 5297; postExpression= 5298 } |> Some
      | 1335 -> { DogmaEffectData.id= 1335; name= "amarrShipEwWeaponDisruptionAF1"; description= ""; displayName= ""; effectCategory= 0; preExpression= 5581; postExpression= 5582 } |> Some
      ...
      | 2790 -> { DogmaEffectData.id= 2790; name= "bcuDamageBonus"; description= ""; displayName= ""; effectCategory= 4; preExpression= 9959; postExpression= 9960 } |> Some
      ...
      | 3081 -> { DogmaEffectData.id= 3081; name= "controlTowerGenericHullExplosiveResistanceBonusJumpPortal"; description= ""; displayName= ""; effectCategory= 0; preExpression= 10817; postExpression= 10818 } |> Some
      | 3372 -> { DogmaEffectData.id= 3372; name= "eliteBonusElectronicAttackShipRocketVelocity2"; description= ""; displayName= ""; effectCategory= 0; preExpression= 11649; postExpression= 11650 } |> Some
      | 3469 -> { DogmaEffectData.id= 3469; name= "testMiningTargetDurationBonus"; description= ""; displayName= ""; effectCategory= 2; preExpression= 11947; postExpression= 11948 } |> Some
      | 3566 -> { DogmaEffectData.id= 3566; name= "shipBonusEwWeaponDisruptionTrackingSpeedBonusAF2"; description= ""; displayName= ""; effectCategory= 0; preExpression= 12260; postExpression= 12261 } |> Some
      | 3663 -> { DogmaEffectData.id= 3663; name= "scanLadarStrengthBonusScannerProbeGroup"; description= ""; displayName= ""; effectCategory= 0; preExpression= 12552; postExpression= 12553 } |> Some
      ...
      | 4051 -> { DogmaEffectData.id= 4051; name= "brokensystemShieldExplosiveResistance"; description= ""; displayName= ""; effectCategory= 7; preExpression= 13558; postExpression= 13559 } |> Some
      | 4148 -> { DogmaEffectData.id= 4148; name= "subsystemBonusCaldariEngineeringLadarECMStrength"; description= ""; displayName= ""; effectCategory= 0; preExpression= 13804; postExpression= 13805 } |> Some
      | 4245 -> { DogmaEffectData.id= 4245; name= "modifyShieldResonanceEMExplosivePassivePreAssignment"; description= ""; displayName= ""; effectCategory= 0; preExpression= 14093; postExpression= 14094 } |> Some
      ...
      | 462 -> { DogmaEffectData.id= 462; name= "shipHybridRangeBonusCF"; description= ""; displayName= ""; effectCategory= 0; preExpression= 2534; postExpression= 2535 } |> Some
      | 4633 -> { DogmaEffectData.id= 4633; name= "eliteBonusViolatorsTorpMissileEMAndEXDAndKinDamageRole"; description= ""; displayName= ""; effectCategory= 0; preExpression= 15127; postExpression= 15128 } |> Some
      | 4730 -> { DogmaEffectData.id= 4730; name= "shipBonusAoeVelocityStandardMissilesDF2"; description= ""; displayName= ""; effectCategory= 0; preExpression= 15313; postExpression= 15314 } |> Some
      ...
      | 5312 -> { DogmaEffectData.id= 5312; name= "shipBonusDroneShieldHitpointsGD1"; description= "Automatically generated effect"; displayName= ""; effectCategory= 0; preExpression= 16825; postExpression= 16826 } |> Some
      | 5409 -> { DogmaEffectData.id= 5409; name= "shipMissileRapidLightROFCBC1"; description= "Automatically generated effect"; displayName= ""; effectCategory= 0; preExpression= 17011; postExpression= 17012 } |> Some
      | 5506 -> { DogmaEffectData.id= 5506; name= "eliteBonusCommandShipHAMRoFCS2"; description= ""; displayName= ""; effectCategory= 0; preExpression= 17271; postExpression= 17272 } |> Some
      | 5603 -> { DogmaEffectData.id= 5603; name= "marauderModeEffect22"; description= ""; displayName= ""; effectCategory= 1; preExpression= 17496; postExpression= 17497 } |> Some
      | 5797 -> { DogmaEffectData.id= 5797; name= "shipBonusEwWeaponDisruptionRangeDisruptionBonusAF2"; description= ""; displayName= ""; effectCategory= 0; preExpression= 17945; postExpression= 17946 } |> Some
      ...
      | 6282 -> { DogmaEffectData.id= 6282; name= "shipBonusEnergyNeutOptimalAF3"; description= ""; displayName= ""; effectCategory= 0; preExpression= 19094; postExpression= 19095 } |> Some
      ...
      | 6767 -> { DogmaEffectData.id= 6767; name= "techTwoCommandBurstBonus"; description= "Automatically generated effect"; displayName= ""; effectCategory= 0; preExpression= 19325; postExpression= 19326 } |> Some
