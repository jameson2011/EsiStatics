...
module internal DogmaAttributes91=
    let getDogmaAttribute id = 
      ...
      | 3098 -> { DogmaAttributeData.id= 3098; name= "armorRepairDurationBonus"; description= ""; published= false; unitId= None; defaultValue= 0.000000; stackable= false; highIsGood= false } |> Some
