...
module internal MarketGroups66=
    let getMarketGroup id = 
      ...
      | 2103 -> { MarketGroupData.id= 2103; name= "Navy Faction"; parentMarketGroupId= Some(2100); typeIds= [| 44928; 47616; 53634; 45910; 46855; 52745; 36366; 52883; 45972; 45851; 42783; 48548; 48551; 48559; 46128; 48561; 36408; 46909; 47168; 48194; 53188; 52430; 46801; 48851; 52437; 46422; 42583; 45792; 45025; 36325; 36458; 46956 |]; description= "" } |> Some
      ...
      | 354698 -> { MarketGroupData.id= 354698; name= "Prototype"; parentMarketGroupId= Some(354693); typeIds= [|  |]; description= "" } |> Some
      | 357 -> { MarketGroupData.id= 357; name= "Drones"; parentMarketGroupId= Some(2); typeIds= [|  |]; description= "Blueprints of drone designs" } |> Some
      | 365950 -> { MarketGroupData.id= 365950; name= "Light Attack Vehicle (LAV)"; parentMarketGroupId= Some(365946); typeIds= [|  |]; description= "LAV." } |> Some
