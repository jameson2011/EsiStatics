...
module internal Groups16=
    let getGroup id = 
      match id with 
      | 1083 -> { GroupData.id= 1083; name= "Eyewear"; categoryId= 30; published= true; typeIds= [| 3958; 4009; 4037; 4038; 4039; 4042; 4043; 4046; 4048; 4050; 4052; 32853; 33992; 33993; 40344; 41575; 41576; 42905; 42906; 45736; 45745; 52317 |] } |> Some
      ...
      | 1568 -> { GroupData.id= 1568; name= "Irregular Frigate"; categoryId= 11; published= false; typeIds= [| 36939; 38659; 40725; 42127; 42512; 46344; 47715; 47717; 48129; 48904; 48905; 48906; 48907; 48940; 48941; 48942; 48955; 49534; 49763; 49807 |] } |> Some
      | 16 -> { GroupData.id= 16; name= "Station Services"; categoryId= 3; published= false; typeIds= [| 26; 27; 28 |] } |> Some
      | 1665 -> { GroupData.id= 1665; name= "Irregular Cruiser"; categoryId= 11; published= false; typeIds= [| 36940; 38658; 40726; 42128; 42513; 46343; 46346; 46347; 47719; 47720; 47722; 48130; 48900; 48901; 48937; 48938; 48939; 48956; 49536; 49764 |] } |> Some
