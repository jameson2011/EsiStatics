...
module internal DogmaEffects0=
    let getDogmaEffect id = 
      ...
      | 1649 -> { DogmaEffectData.id= 1649; name= "skillCynosuralTheoryConsumptionQuantityBonus"; description= ""; displayName= ""; effectCategory= 0; preExpression= 6547; postExpression= 6548 } |> Some
      ...
      | 3104 -> { DogmaEffectData.id= 3104; name= "controlTowerGenericHullEmResistanceBonusStasis"; description= ""; displayName= ""; effectCategory= 0; preExpression= 10913; postExpression= 10914 } |> Some
      ...
      | 3492 -> { DogmaEffectData.id= 3492; name= "industrialCoreEffect"; description= ""; displayName= ""; effectCategory= 1; preExpression= 11992; postExpression= 11993 } |> Some
      ...
      | 3880 -> { DogmaEffectData.id= 3880; name= "subsystemBonusAmarrElectronicSignatureRadius"; description= ""; displayName= ""; effectCategory= 0; preExpression= 13125; postExpression= 13126 } |> Some
      | 3977 -> { DogmaEffectData.id= 3977; name= "subsystemBonusGallenteDefensiveShieldHP"; description= ""; displayName= ""; effectCategory= 0; preExpression= 13319; postExpression= 13320 } |> Some
      | 4074 -> { DogmaEffectData.id= 4074; name= "systemHeavyMissileEmDamage"; description= ""; displayName= ""; effectCategory= 7; preExpression= 13621; postExpression= 13622 } |> Some
      | 4171 -> { DogmaEffectData.id= 4171; name= "subsystemBonusGallenteEngineeringOffensiveHybridWeaponROF"; description= ""; displayName= ""; effectCategory= 0; preExpression= 13859; postExpression= 13860 } |> Some
      ...
      | 5141 -> { DogmaEffectData.id= 5141; name= "orbitalStrike"; description= ""; displayName= ""; effectCategory= 1; preExpression= 59; postExpression= 59 } |> Some
      ...
      | 7178 -> { DogmaEffectData.id= 7178; name= "bombDeploymentSkillBoostReactivationBonus"; description= ""; displayName= ""; effectCategory= 0; preExpression= 1217; postExpression= 1218 } |> Some
      ...
      | 970 -> { DogmaEffectData.id= 970; name= "smartbombKineticBonus"; description= ""; displayName= ""; effectCategory= 4; preExpression= 4331; postExpression= 4332 } |> Some
      | _ -> None