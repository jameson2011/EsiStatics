...
module internal Groups53=
    let getGroup id = 
      ...
      | 1896 -> { GroupData.id= 1896; name= "♦ Industrial Command "; categoryId= 11; published= false; typeIds= [| 46046; 46047; 46048; 46049; 48134; 53534; 53568 |] } |> Some
      | 1993 -> { GroupData.id= 1993; name= "Exotic Plasma Charge Blueprint"; categoryId= 9; published= true; typeIds= [| 48097; 48098; 48099; 48102; 48103; 48104; 48107; 48108; 48109; 53031; 53303; 53304 |] } |> Some
      | 344 -> { GroupData.id= 344; name= "Tracking Enhancer Blueprint"; categoryId= 9; published= true; typeIds= [| 11616; 11848; 15966 |] } |> Some
      | 4030 -> { GroupData.id= 4030; name= "Rakovene"; categoryId= 25; published= true; typeIds= [| 52315; 56629; 56630 |] } |> Some
