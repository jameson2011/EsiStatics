...
module internal MarketGroups67=
    let getMarketGroup id = 
      ...
      | 2007 -> { MarketGroupData.id= 2007; name= "Amarr"; parentMarketGroupId= Some(2085); typeIds= [| 34752; 34753; 42595; 42596; 43525; 45804; 42795; 42796; 45805; 53646; 53647; 55312; 37524; 37525; 46744; 43524; 55322; 46813; 46814 |]; description= "" } |> Some
      | 2104 -> { MarketGroupData.id= 2104; name= "Amarr"; parentMarketGroupId= Some(2102); typeIds= [| 53632; 53633; 37513; 37514; 53007; 42781; 42782; 52774; 55341; 55349; 46799; 46800; 48852; 48853; 42582; 36312; 36314; 45790; 45791; 48243; 48244; 43513; 43514; 42581 |]; description= "" } |> Some
