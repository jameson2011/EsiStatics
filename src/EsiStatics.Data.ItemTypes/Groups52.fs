...
module internal Groups52=
    let getGroup id = 
      ...
      | 1992 -> { GroupData.id= 1992; name= "Entropic Radiation Sink Blueprint"; categoryId= 9; published= true; typeIds= [| 48095; 48096 |] } |> Some
      ...
      | 537 -> { GroupData.id= 537; name= "Dreadnought Blueprint"; categoryId= 9; published= true; typeIds= [| 19721; 19723; 19725; 19727; 34340; 34342; 34344; 34346; 42136; 45044; 45646 |] } |> Some
