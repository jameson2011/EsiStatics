...
module internal MarketGroups2=
    let getMarketGroup id = 
      ...
      | 2039 -> { MarketGroupData.id= 2039; name= "Caldari"; parentMarketGroupId= Some(2037); typeIds= [| 36357; 45831; 36648; 48174; 36720; 40596; 46839; 52632; 46108 |]; description= "" } |> Some
