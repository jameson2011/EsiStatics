...
module internal MarketGroups2=
    let getMarketGroup id = 
      ...
      | 2039 -> { MarketGroupData.id= 2039; name= "Caldari"; parentMarketGroupId= Some(2037); typeIds= [| 53168; 36357; 45831; 36648; 48174; 36720; 55560; 40596; 46839; 52632; 57012; 46108 |]; description= "" } |> Some
      ...
      | 293 -> { MarketGroupData.id= 293; name= "Medium"; parentMarketGroupId= Some(288); typeIds= [| 47971; 839; 840; 841; 842; 843; 48471; 48472; 52349 |]; description= "Blueprints of medium laser turrets." } |> Some
