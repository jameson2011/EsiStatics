...
module internal MarketGroups44=
    let getMarketGroup id = 
      ...
      | 1984 -> { MarketGroupData.id= 1984; name= "Amarr"; parentMarketGroupId= Some(1972); typeIds= [| 46817; 42599; 43528; 46537; 34666; 34667; 52782; 42799; 45808; 48369; 53650; 36310; 37528 |]; description= "" } |> Some
      | 2081 -> { MarketGroupData.id= 2081; name= "Amarr"; parentMarketGroupId= Some(2068); typeIds= [| 48848; 52578; 52579; 37508; 37509; 36294; 46791; 46792; 45783; 42573; 42574; 45782; 48849; 52771; 43508; 36309; 42774; 42775; 53624; 53625; 43509 |]; description= "" } |> Some
      ...
      | 2372 -> { MarketGroupData.id= 2372; name= "Gallente"; parentMarketGroupId= Some(2369); typeIds= [| 46025; 46948; 46414; 45902; 52737 |]; description= "" } |> Some
