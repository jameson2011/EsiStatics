...
module internal MarketGroups39=
    let getMarketGroup id = 
      ...
      | 1979 -> { MarketGroupData.id= 1979; name= "Gallente"; parentMarketGroupId= Some(2381); typeIds= [| 45921; 46967; 46551; 46433; 50152; 44939; 37586; 42190; 34674; 34675; 47540; 45582; 36375; 52440; 49428; 52756; 47643; 50079 |]; description= "" } |> Some
      | 2076 -> { MarketGroupData.id= 2076; name= "Minmatar"; parentMarketGroupId= Some(2066); typeIds= [| 46018; 48507; 36773; 45960; 40490; 46897; 36434; 36820; 47163 |]; description= "" } |> Some
      ...
      | 2658 -> { MarketGroupData.id= 2658; name= "Triglavian"; parentMarketGroupId= Some(65); typeIds= [| 52312; 52313; 52314; 52310; 52311 |]; description= "Advanced Components of Triglavian origin." } |> Some
      ...
      | 621 -> { MarketGroupData.id= 621; name= "Implant Slot 04"; parentMarketGroupId= Some(532); typeIds= [| 28804; 33925; 28810; 33559; 32109; 28816; 33937; 20502; 20503; 33967; 2589; 33955; 33943; 33961; 33949; 33973; 20159; 33931; 33526; 52681; 31970; 19537; 31956; 9943; 42200; 14298; 33807; 31964; 22109; 42207; 19554; 22115; 42213; 13287; 31976; 22121; 32103; 10221; 10222; 22127; 32114; 22134; 32119; 28792; 28798; 33919 |]; description= "Implants intended for Subcervical Processing Slot 4." } |> Some
