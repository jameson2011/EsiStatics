...
module internal MarketGroups39=
    let getMarketGroup id = 
      ...
      | 1688 -> { MarketGroupData.id= 1688; name= "Thermal Shield Amplifiers"; parentMarketGroupId= Some(550); typeIds= [| 9568; 14728; 19211; 14724; 19237; 14726; 15921; 1800; 2537; 14730; 2539; 19239; 14033; 14035; 14614; 15913; 19219; 19251; 14618; 19227; 20607 |]; description= "Thermal Shield Amplifiers" } |> Some
      ...
      | 1979 -> { MarketGroupData.id= 1979; name= "Gallente"; parentMarketGroupId= Some(2381); typeIds= [| 45921; 46967; 46551; 46433; 50152; 44939; 37586; 42190; 34674; 34675; 47540; 45582; 36375; 52440; 49428; 52756; 47643; 53431; 55572; 50079 |]; description= "" } |> Some
      | 2076 -> { MarketGroupData.id= 2076; name= "Minmatar"; parentMarketGroupId= Some(2066); typeIds= [| 56896; 46018; 48507; 36773; 52871; 45960; 40490; 46897; 36434; 36820; 47163; 55690 |]; description= "" } |> Some
