...
module internal MarketGroups17=
    let getMarketGroup id = 
      ...
      | 1957 -> { MarketGroupData.id= 1957; name= "Caldari"; parentMarketGroupId= Some(2101); typeIds= [| 49153; 46850; 46851; 46852; 49800; 46731; 47629; 53135; 53010; 45846; 45847; 45848; 40607; 40608; 40609; 48550; 52401; 46377; 46123; 46124; 46125; 53373; 34609; 34610; 36659; 36660; 36661; 48189; 48190; 48191; 53184; 53185; 48834; 54561; 35150; 52559; 47312; 45015; 48217; 48730; 48225; 53183; 48729; 54766; 52285; 46714; 36731; 36732; 36733; 47615 |]; description= "" } |> Some
      | 2054 -> { MarketGroupData.id= 2054; name= "Minmatar"; parentMarketGroupId= Some(2044); typeIds= [| 46882; 46883; 36806; 36807; 36424; 48493; 48494; 36436; 45941; 45942; 36759; 36760; 52852; 40475; 40476; 52853 |]; description= "" } |> Some
      ...
      | 2151 -> { MarketGroupData.id= 2151; name= "Ice Mining Lasers"; parentMarketGroupId= Some(1713); typeIds= [| 37450; 37451; 37452 |]; description= "Ice mining laser designs." } |> Some
      ...
      | 696 -> { MarketGroupData.id= 696; name= "Medium"; parentMarketGroupId= Some(663); typeIds= [| 19077; 19079; 16489; 19083; 31948; 19085; 23854; 16495; 19081; 12217; 19087; 12221 |]; description= "Cruiser-sized energy transfer arrays." } |> Some
