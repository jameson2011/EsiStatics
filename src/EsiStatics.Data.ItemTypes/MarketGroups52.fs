...
module internal MarketGroups52=
    let getMarketGroup id = 
      ...
      | 1992 -> { MarketGroupData.id= 1992; name= "Gallente"; parentMarketGroupId= Some(2028); typeIds= [| 34689; 34690; 34691; 34692; 34693; 34694; 34695; 34696; 47502; 36369; 44182; 44183; 44184; 44185; 46405; 48555; 46406; 46404; 47529; 47530; 46407; 42166; 42167; 42168; 42169; 37563; 37564; 37565; 37566; 37057; 45892; 45893; 45894; 45895; 48721; 50002; 52435; 48228; 46562; 46564; 44910; 44911; 44912; 44913; 52395; 46718; 45565; 45566 |]; description= "" } |> Some
      | 2089 -> { MarketGroupData.id= 2089; name= "Caldari"; parentMarketGroupId= Some(2087); typeIds= [| 48208; 46754; 36675; 36676; 52561; 45865; 45866; 36747; 36748; 40623; 40624; 48209; 46755; 46869; 46870; 36348; 36349; 46142; 46143 |]; description= "" } |> Some
      ...
      | 2477 -> { MarketGroupData.id= 2477; name= "Implant Slot 09"; parentMarketGroupId= Some(2473); typeIds= [| 48148; 48149 |]; description= "Implant Slot 09" } |> Some
      | 343 -> { MarketGroupData.id= 343; name= "Weapon Upgrades"; parentMarketGroupId= Some(210); typeIds= [| 11616; 11617; 11621; 33401; 1096; 35772; 49971; 35791; 27952; 28584; 12275; 52243; 52245; 20281; 9945; 11612; 48095 |]; description= "Blueprints of weapon upgrades." } |> Some
      | 354490 -> { MarketGroupData.id= 354490; name= "Small"; parentMarketGroupId= Some(353608); typeIds= [|  |]; description= "" } |> Some
      | 355460 -> { MarketGroupData.id= 355460; name= "Turrets"; parentMarketGroupId= Some(355449); typeIds= [|  |]; description= "" } |> Some
      | 369234 -> { MarketGroupData.id= 369234; name= "Boosters & Services"; parentMarketGroupId= Some(350001); typeIds= [|  |]; description= "Boosters and Services" } |> Some
