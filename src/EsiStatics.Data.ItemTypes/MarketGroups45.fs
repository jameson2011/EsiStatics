...
module internal MarketGroups45=
    let getMarketGroup id = 
      ...
      | 1985 -> { MarketGroupData.id= 1985; name= "Caldari"; parentMarketGroupId= Some(1972); typeIds= [| 46144; 36677; 55527; 45867; 34668; 36749; 52562; 40625; 48210; 53204; 46871 |]; description= "" } |> Some
      ...
      | 2373 -> { MarketGroupData.id= 2373; name= "Minmatar"; parentMarketGroupId= Some(2369); typeIds= [| 55652; 45964; 46026; 52875; 52428; 46901; 48511 |]; description= "" } |> Some
