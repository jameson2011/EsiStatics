...
module internal MarketGroups74=
    let getMarketGroup id = 
      ...
      | 1529 -> { MarketGroupData.id= 1529; name= "Interdiction Probes"; parentMarketGroupId= Some(1520); typeIds= [| 22779; 56749 |]; description= "Interdiction Probes" } |> Some
      ...
      | 2111 -> { MarketGroupData.id= 2111; name= "Caldari"; parentMarketGroupId= Some(2109); typeIds= [| 36355; 55558; 48198; 40615; 53192; 46859; 36739; 46132; 36667; 45855 |]; description= "" } |> Some
      ...
      | 2693 -> { MarketGroupData.id= 2693; name= "Triglavian"; parentMarketGroupId= Some(1883); typeIds= [| 53035; 53036; 53037 |]; description= "" } |> Some
