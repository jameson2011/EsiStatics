...
module internal MarketGroups94=
    let getMarketGroup id = 
      ...
      | 967 -> { MarketGroupData.id= 967; name= "Signal Distortion Amplifier"; parentMarketGroupId= Some(677); typeIds= [| 25561; 25563; 25565 |]; description= "Ship systems that amplify the distortion signal generated by electronic counter measure systems." } |> Some
      | _ -> None