...
module internal DogmaAttributes51=
    let getDogmaAttribute id = 
      ...
      | 633 -> { DogmaAttributeData.id= 633; name= "metaLevelOld"; description= "Authoring has been moved to FSD  The ranking of the module within its tech level"; published= true; unitId= Some(140); defaultValue= 0.000000; stackable= true; highIsGood= true } |> Some
