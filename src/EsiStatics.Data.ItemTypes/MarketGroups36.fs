...
module internal MarketGroups36=
    let getMarketGroup id = 
      ...
      | 1976 -> { MarketGroupData.id= 1976; name= "Gallente"; parentMarketGroupId= Some(2374); typeIds= [| 46721; 45573; 45574; 44937; 44938; 47504; 52754; 49427; 50078; 36522; 47538; 36401; 36402; 47539; 34654; 47290; 45919; 45920; 42188; 42189; 37584; 37585; 50004; 48213; 34653; 46558; 46431; 34656; 46561; 34655; 50150; 50151; 46432; 52755; 46965; 46966 |]; description= "" } |> Some
      | 2073 -> { MarketGroupData.id= 2073; name= "Amarr"; parentMarketGroupId= Some(2066); typeIds= [| 46529; 37506; 52772; 46789; 36297; 42571; 43506; 42772; 45780 |]; description= "" } |> Some
      ...
      | 618 -> { MarketGroupData.id= 618; name= "Implant Slot 01"; parentMarketGroupId= Some(532); typeIds= [| 28802; 33923; 28808; 33929; 28814; 33935; 20498; 20499; 33941; 20121; 33947; 33953; 2082; 33959; 9899; 33965; 33971; 52674; 42145; 19534; 31954; 19540; 14295; 33555; 31962; 22107; 42204; 31968; 22113; 42210; 13283; 32101; 31974; 22119; 10216; 10217; 32107; 33516; 22125; 32112; 22760; 22131; 32117; 28790; 28796; 33917 |]; description= "Implants intended for Subcervical Processing Slot 1." } |> Some
