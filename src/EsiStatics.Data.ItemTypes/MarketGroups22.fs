...
module internal MarketGroups22=
    let getMarketGroup id = 
      ...
      | 1574 -> { MarketGroupData.id= 1574; name= ""; parentMarketGroupId= Some(1566); typeIds= [| 40338; 11614 |]; description= "" } |> Some
      ...
      | 2059 -> { MarketGroupData.id= 2059; name= "Amarr"; parentMarketGroupId= Some(2046); typeIds= [| 42757; 42758; 47621; 52768; 55344; 55351; 46779; 42556; 36287; 36288; 45764; 45765; 48843; 52569; 52570; 43493; 42555; 43494; 53606; 53607; 46780; 37495; 37496 |]; description= "" } |> Some
      ...
      | 2738 -> { MarketGroupData.id= 2738; name= "Medium"; parentMarketGroupId= Some(2730); typeIds= [| 54785; 54786 |]; description= "" } |> Some
      ...
      | 701 -> { MarketGroupData.id= 701; name= "Heavy"; parentMarketGroupId= Some(668); typeIds= [| 15136; 15138; 23811; 15140; 15142; 15132; 15786; 15778; 20559; 15128; 15134; 3576; 3578; 5051; 14172; 15130; 14174 |]; description= "Battleship-sized capacitor boosters." } |> Some
